/* social_order_v0.16 · Mock-Daten (keine externen Abhängigkeiten)
   Hinweis: Version steht zusätzlich in SOCIAL_ORDER.mock.meta.version */

window.SOCIAL_ORDER = window.SOCIAL_ORDER || {};
...
SOCIAL_ORDER.mock = {
  ...
  "catalog": [
    ...
    {
      "id": "A-013",
      "title": "Briefumschläge DIN lang (100)",
      "unit": "Packung",
      "price": 3.29,
      "vendor": "OfficePro GmbH",
      "contract": "Rahmenvertrag 1",
    ...
    {
      "id": "A-024",
      "title": "Kopierpapier A4 Recycling (500 Blatt)",
      "unit": "Paket",
      "price": 5.29,
      "vendor": "PrintLine AG",
      "contract": "Rahmenvertrag 2",
    ...
    {
      "id": "A-025",
      "title": "Kopierpapier A3 (500 Blatt)",
      "unit": "Paket",
      "price": 9.49,
      "vendor": "PrintLine AG",
      "contract": "Rahmenvertrag 2",
    ...
    {
      "id": "A-028",
      "title": "Druckerpatrone schwarz (Modell ABC)",
      "unit": "Stück",
      "price": 39.0,
      "vendor": "PrintLine AG",
      "contract": "Rahmenvertrag 2",
    ...
    {
      "id": "A-031",
      "title": "Papierkarton A4 160 g (250 Blatt)",
      "unit": "Packung",
      "price": 12.49,
      "vendor": "PrintLine AG",
      "contract": "Rahmenvertrag 2",
    ...
    {
      "id": "A-034",
      "title": "Druckerpapier Fotoglanz A4 (50 Blatt)",
      "unit": "Packung",
      "price": 11.99,
      "vendor": "PrintLine AG",
      "contract": "Rahmenvertrag 2",
    ...
    {
      "id": "A-040",
      "title": "Whiteboard-Reiniger (250 ml)",
      "unit": "Flasche",
      "price": 5.49,
      "vendor": "MeetingTools KG",
      "contract": "Rahmenvertrag 3",
    ...
    {
      "id": "A-043",
      "title": "Pinnwand 120×90 cm (mobil)",
      "unit": "Stück",
      "price": 129.0,
      "vendor": "MeetingTools KG",
      "contract": "Rahmenvertrag 3",
    ...
    {
      "id": "A-044",
      "title": "Whiteboard mobil (120×90 cm)",
      "unit": "Stück",
      "price": 149.0,
      "vendor": "MeetingTools KG",
      "contract": "Rahmenvertrag 3",
    ...
    {
      "id": "A-045",
      "title": "Flipchart-Ständer (klappbar)",
      "unit": "Stück",
      "price": 79.0,
      "vendor": "MeetingTools KG",
      "contract": "Rahmenvertrag 3",
    ...
    },
    {
      ...
      "group": "board",
      "special": true,
      "specialNote": "Wandmontage erfordert Begründung"
    },
    {
      "id": "A-047",
      "title": "Handseife (500 ml)",
      "unit": "Flasche",
      "price": 2.49,
      "vendor": "OfficePro GmbH",
      "contract": "Rahmenvertrag 1",
    ...
    {
      "id": "A-048",
      "title": "Toilettenpapier (10 Rollen)",
      "unit": "Pack",
      "price": 4.99,
      "vendor": "OfficePro GmbH",
      "contract": "Rahmenvertrag 1",
    ...
    {
      "id": "A-053",
      "title": "Desinfektionstücher (80 Stk.)",
      "unit": "Pack",
      "price": 3.99,
      "vendor": "OfficePro GmbH",
      "contract": "Rahmenvertrag 1",
    ...
    {
      "id": "A-054",
      "title": "Kaffeefilter Größe 4 (100)",
      "unit": "Pack",
      "price": 1.69,
      "vendor": "OfficePro GmbH",
      "contract": "Rahmenvertrag 1",
    ...
    {
      "id": "A-056",
      "title": "Papierhandtücher (150 Blatt)",
      "unit": "Pack",
      "price": 2.79,
      "vendor": "OfficePro GmbH",
      "contract": "Rahmenvertrag 1",
...
------------------------------------------------------------ */
(function(){
  const mock = (window.SOCIAL_ORDER && window.SOCIAL_ORDER.mock) ? window.SOCIAL_ORDER.mock : null;
  if(!mock) return;
